<template>
  <div class="row">
      <div class="card offset-2 col-md-3">
        <div class="card-body tex-center d-flex align-items-center flex-column">    <!-- image import -->
        ...
        <div class="col-md-11 card">
          <div class="card-body">
            <div class="form-group">
              ...
              <input v-model="product.title" type="text" class="form-control" placeholder="adını giriniz">
            </div>
            <div class="row">
              <div class="form-group col-md-6">
                <label>Ürün Adeti</label>
                <input v-model="product.count" type="text" class="form-control" placeholder="adetini giriniz">
              </div>
              <div class="form-group col-md-6">
                <label>Ürün Fiyatı</label>
                <input v-model="product.price" type="text" class="form-control" placeholder="fiyatını giriniz">
              </div>
            </div>
